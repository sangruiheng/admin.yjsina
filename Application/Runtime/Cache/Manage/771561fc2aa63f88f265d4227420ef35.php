...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div>
        ...
        <form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/NavCategory/navCategoryList">
...
<div class="list-box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                    <a class="btn btn-success navbar-btn" href="/manage.php/NavCategory/SecondLevel?navcate_pid=<?php echo ($vo["id"]); ?>&navcate_name=<?php echo ($vo["navcate_name"]); ?>" > 管理二级分类</a>
                </td>
