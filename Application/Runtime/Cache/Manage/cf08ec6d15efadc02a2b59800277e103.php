...
<a class="navbar-brand" href="#">字典类型管理</a>
</div>
<div>
...
<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_save_id');?>" class="btn btn-info navbar-btn listButton" onclick="editData('addDictionaryType')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_add_id');?>" class="btn btn-success navbar-btn listButton" onclick="openAddData('addDictionaryType')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>
<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/System/dictionaryTypeList">
