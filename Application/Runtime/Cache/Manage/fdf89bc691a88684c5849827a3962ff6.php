...
$(document).ready(function(e) {
    ...
    <script type="text/javascript" src="/Public/Manage/js/product/product.js"></script>
...
<div class="add-box">
    <form id="form1" class="addForm ajax-alert" name="form1" method="post" action="/manage.php/Product/addProduct/controller/Product/backUrl/productList/table/product">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <input type="hidden" name="productPage" value="<?php echo ($productPage); ?>">
