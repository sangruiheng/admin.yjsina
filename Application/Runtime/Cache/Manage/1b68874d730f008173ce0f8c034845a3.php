...
<a class="navbar-brand" href="#">用户群组管理</a>
</div>
<div>
<!--<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_del_id');?>" class="btn btn-danger navbar-btn listButton" onclick="deleteData('Group')"><i class="fa fa-trash-o" aria-hidden="true"></i> 删除</button>-->
<!--<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_save_id');?>" class="btn btn-info navbar-btn listButton" onclick="editData('addGroup')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>-->
<!--<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_add_id');?>" class="btn btn-success navbar-btn listButton" onclick="openAddData('addGroup')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>-->

    <button type="button" class="btn btn-danger navbar-btn listButton authButton" onclick="deleteData('Groups')"><i class="fa fa-trash-o" aria-hidden="true"></i> 删除</button>
    <button type="button" class="btn btn-info navbar-btn listButton authButton" onclick="editData('addGroup')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
    <button type="button" class="btn btn-success navbar-btn listButton authButton" onclick="openAddData('addGroup')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>

    <form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/System/groupList">
...
<td><?php echo status('group',$vo['id'],$vo['status'],'status',array('正常','禁用'),array('#5cb85c','#d9534f'));?></td>
