...
<a class="navbar-brand" href="#">意见管理</a>
</div>
<div>
	<button type="button" class="btn btn-info navbar-btn listButton" onclick="editData('catFeed')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 查看内容</button>
	<!--<button type="button" class="btn btn-danger navbar-btn listButton" onclick="deleteData('feed')"><i class="fa fa-trash-o" aria-hidden="true"></i> 删除</button>-->
<!--<button type="button" class="btn btn-info navbar-btn listButton" onclick="editData('addFeed')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>-->
<!--<button type="button" class="btn btn-success navbar-btn listButton" onclick="openAddData('addFeed')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>-->
<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/Feed/feedList">
...
<td><?php echo ($vo["id"]); ?></td>
	<?php if($vo['user']['nickName']): ?><td><?php echo ($vo["user"]["nickName"]); ?></td>
		<?php else: ?>
        <td><?php echo ($vo["user"]["tel"]); ?></td><?php endif; ?>
