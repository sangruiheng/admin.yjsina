    ...
    <script>
        $(document).ready(function(e) {
            ...
            getEditData(function (e) {
                ...
                uploadImg += '<img src="/Uploads/Manage/' + e.navcate_img + '" width="120" height="120">';
                uploadImg += '<div class="upload-ldButton" data-url="' + e.navcate_img+ + '">';
...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="#"><i class="fa fa-plus" aria-hidden="true"></i> <span id="changeTitle">添加</span>二级分类</a>
    </div>
</nav>

<div class="add-box">
    <form class="addForm ajax-fadein" id="form1" name="form1" method="post" action="/manage.php/NavCategory/addSecond/controller/NavCategory/backUrl/SecondLevel/table/navcategory">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><input type="text" name="navcate_name" id="navcate_name" class="form-control"  datatype="*" nullmsg="请输入二级分类名称" placeholder="请输入二级分类名称" /></td>
            </tr>

            <tr>
                <td align="center">二级分类缩略图<font color="red">&nbsp;&nbsp;*</font><br/><font color="#e61111" class="imgSize">200*200</font></td>
