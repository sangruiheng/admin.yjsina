...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="#"><i class="fa fa-plus" aria-hidden="true"></i> <span id="changeTitle">添加</span>关于我们</a>
    </div>
</nav>

<div class="add-box">
    <form class="addForm ajax-fadein" id="form1" name="form1" method="post" action="/manage.php/Help/addAboutData/controller/Help/backUrl/aboutList/table/help">
        <input name="id" type="hidden" id="id" value="<?php echo $aboutList['id']?>" />
