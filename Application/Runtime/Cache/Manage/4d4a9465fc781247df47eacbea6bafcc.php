...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="#"><i class="fa fa-plus" aria-hidden="true"></i> <span id="changeTitle">添加</span>新闻专题类型</a>
    </div>
</nav>

<div class="add-box">
    <form class="addForm ajax-fadein" id="form1" name="form1" method="post" action="/manage.php/Common/addData/controller/News/backUrl/newsTypeList/table/newstype">
        <input name="id" type="hidden" id="id" value="<?php echo ($_GET['id']); ?>" />
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr>
                <td align="center">新闻类型</td>
                <td><input type="text" name="typeName" id="typeName" class="form-control"  datatype="*" nullmsg="请输入新闻类型" placeholder="请输入新闻类型" /></td>
            </tr>
