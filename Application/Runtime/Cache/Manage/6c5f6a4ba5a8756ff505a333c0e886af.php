...
<div>
<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_del_id');?>" class="btn btn-danger navbar-btn listButton" onclick="deleteData('Adminuser')"><i class="fa fa-trash-o" aria-hidden="true"></i> 删除</button>
<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_save_id');?>" class="btn btn-info navbar-btn listButton" onclick="editData('addAdminuser')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
<button type="button" data-id="<?php echo C('AUTH_MODULE.auth_add_id');?>" class="btn btn-success navbar-btn listButton" onclick="javascript:window.location.href='/manage.php/System/addAdminuser'"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>

<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/System/adminuserList">
