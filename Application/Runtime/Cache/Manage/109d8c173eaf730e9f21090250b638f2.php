...
var URL = '/manage.php/NavCategory';
...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="#">当前一级分类:<?php echo ($category["navcate_name"]); ?></a>
    </div>
    <div>
        ...
        <button type="button" value="<?php echo ($_GET['navcate_pid']); ?>" class="btn btn-danger navbar-btn listButton" onclick="deleteCate(this,'navcategory')"><i class="fa fa-trash-o" aria-hidden="true"></i> 删除</button>
        ...
        <button type="button" value="<?php echo ($category["id"]); ?>" class="btn btn-success navbar-btn listButton" onclick="openAddSecondLevel(this,'addSecondLevel')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>
        <form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/NavCategory/SecondLevel">
