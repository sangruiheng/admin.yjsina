...
<nav class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<a class="navbar-brand" href="#">限时购商品管理</a>
	</div>
	<div>
		...
		<button type="button" class="btn btn-info navbar-btn listButton" onclick="editData('addSupplyProduct')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
		<button type="button" class="btn btn-success navbar-btn listButton" onclick="openAddData('addSupplyProduct')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>
		<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/Product/supplyProductList">
...
<div class="list-box">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php echo ($vo["discount_starttime"]); ?></td>
				<td><?php echo ($vo["discount_endtime"]); ?></td>
