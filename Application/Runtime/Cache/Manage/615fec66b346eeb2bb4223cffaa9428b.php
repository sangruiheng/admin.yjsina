...
<nav class="navbar navbar-default" role="navigation">
	...
	<div>
		...
		<button type="button" class="btn btn-info navbar-btn listButton" onclick="editData('addCommercial')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
		<button type="button" class="btn btn-success navbar-btn listButton" onclick="openAddData('addCommercial')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>
		<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/Banner/commercialList">
