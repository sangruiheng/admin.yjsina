...
<nav class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<a class="navbar-brand" href="#">家电广告位管理</a>
	</div>
	<div>
		...
		<button type="button" class="btn btn-info navbar-btn listButton" onclick="editData('addAdvertising')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
		<!--<button type="button" class="btn btn-success navbar-btn listButton" onclick="openAddData('addAdvertising')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>-->
		<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/Banner/advertisingList">
